                ...
                <div className="table__row">
                    ...
                    <div className="table__contact">
                        <div className="table__contact_address">
                            <span>address</span>
                            <p className="table__contact_address-info">Oude Amersfoortseweg 125</p>
                        ...
                        <div className="table__contact_contact">
                            <span>contact</span>
                            <a href="mailto: hilversum@mediamonks.com" className="table__contact_link">hilversum@mediamonks.com</a>
                            <a href="tel: +31 35 621 21 50" className="table__contact_link">+31 35 621 21 50</a>
                        </div>
                    </div>
                </div>
                <div className="table__row">
                    ...
                    <div className="table__contact">
                        ...
                        <div className="table__contact_contact">
                            <span>contact</span>
                            <a href="mailto: nursultan@mediamonks.com" className="table__contact_link">nursultan@mediamonks.com</a>
                            <a href="tel: +7 (7172) 790389" className="table__contact_link">+7 (7172) 790389</a>
                        </div>
                    </div>
                </div>
                <div className="table__row">
                    ...
                    <div className="table__contact">
                        ...
                        <div className="table__contact_contact">
                            <span>contact</span>
                            <a href="mailto: amsterdam@mediamonks.com" className="table__contact_link">amsterdam@mediamonks.com</a>
                            <a href="tel: +31 20 820 24 25" className="table__contact_link">+31 20 820 24 25</a>
                        </div>
                    </div>
                </div>
                <div className="table__row">
                    ...
                    <div className="table__contact">
                        <div className="table__contact_address">
                            ...
                            <p className="table__contact_address-info">per. Malyy Cherkasskiy, 2</p>
                        ...
                        <div className="table__contact_contact">
                            <span>contact</span>
                            <a href="mailto: moscow@mediamonks.com" className="table__contact_link">moscow@mediamonks.com</a>
                            <a href="tel: +7 499 110 44 75" className="table__contact_link">+7 499 110 44 75</a>
                        </div>
                    </div>
                </div>
            </div>
